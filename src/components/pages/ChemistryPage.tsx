...
export function ChemistryPage({tank}:{tank:Tank}) {
 ...
 <div className="card panel"><h3>{tr(lang,"chemistryHealth")}</h3><b className="big-number">{chemistryHealth(tank)}%</b><p className="note">{bi(lang,"يمكنك التسجيل يدوياً أو استيراد عدة قراءات دفعة واحدة من القالب.","Add readings manually or bulk-import multiple readings from the template.")}</p></div>
