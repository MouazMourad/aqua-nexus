  ...
  {step<5&&<div className="card acclimation-wizard full-span">
    ...
    <div className="acclimation-wizard-body">
      ...
      <div className="acclimation-essential-grid">
       <label className="field"><span>{tr(lang,"category")}</span><select value={category} onChange={e=>{const c=e.target.value as Cat;setCategory(c);setSelected("");setCustom("");setDrip(c==="invert"?45:c==="fish"?20:20);setIntervalMin(c==="coral"?5:c==="plant"?0:15);setSubtype(tank.type==="marine"&&c==="plant"?"macroalgae":"")}}>{selectedCats.map(c=><option key={c} value={c}>{categoryLabel(c)}</option>)}</select></label>
       ...
       <label className="field"><span>{tr(lang,"quantity")}</span><input type="number" min="1" value={qty} onChange={e=>setQty(Number(e.target.value))}/></label>
      ...
      {showItemAdvanced&&<div className="acclimation-item-advanced"><div className="form-grid">
       ...
       <label className="field"><span>{tr(lang,"dripMinutes")}</span><input type="number" min="0" value={drip} onChange={e=>setDrip(Number(e.target.value))}/></label>
       <label className="field"><span>{tr(lang,"releaseInterval")}</span><input type="number" min="0" value={interval} onChange={e=>setIntervalMin(Number(e.target.value))}/></label>
