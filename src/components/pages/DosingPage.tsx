...
export function DosingPage({tank}:{tank:Tank}) {
 ...
 const dosingReady=Boolean(latestReading)&&latestParamValue!==undefined&&readingAgeHours<=48&&!dataIssue&&latestReading?.confidence!=="low";
