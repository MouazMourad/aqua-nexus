...
export function SumpPage({tank}:{tank:Tank}) {
 ...
 const save=()=>{if(!edit||!draft)return;patch(tank.id,t=>({...t,sump:{...t.sump,chambers:t.sump.chambers.map(x=>x.id===edit?fitChamberToSump(draft,t.sump.dimensions):x)}}));setEdit(null)};
