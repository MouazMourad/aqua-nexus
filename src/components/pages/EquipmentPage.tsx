  ...
  <Modal open={!!e} title={e?.name??tr(lang,"equipment")} onClose={()=>setDetails(null)}>
   {e&&profile&&<>
    <div className="form-grid">
      ...
      <label className="field"><span>{bi(lang,"القدرة W","Power W")}</span><input type="number" min="0" value={e.powerWatts??""} onChange={ev=>updateDevice(e.id,x=>({...x,powerWatts:sanitizeNonNegative(Number(ev.target.value),x.powerWatts??0,100000)}))}/></label>
