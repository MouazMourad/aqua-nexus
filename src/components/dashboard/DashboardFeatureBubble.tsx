...
export function DashboardFeatureBubble(){
  ...
  return <div className="feature-bubble-lane" aria-hidden="true">
    ...
    <style jsx>{`
      ...
      .feature-bubble{position:absolute;inset-inline-end:clamp(12px,4vw,58px);bottom:-190px;width:min(360px,calc(100vw - 28px));pointer-events:none;animation:aquaBubbleRise 5s linear forwards;filter:drop-shadow(0 14px 28px rgba(0,0,0,.28))}
