...
export function AquaDashboard() {
 ...
 const allPages:AppPage[]=["dashboard","tanks","equipment","lighting","sump","livestock","lifejourney","breeding","consumption","acclimation","library","chemistry","maintenance","inventory","diseases","timeline","journal","waterchange","feeding","dosing","quarantine","emergency","rodi","expenses","alerts","reports","settings","academy"];
