 ...
 * the full image and its display preview are written to IndexedDB first, then
 * tank state keeps only metadata + storage references. This also upgrades the
 * earlier format that left a thumbnail inside localStorage.
 */
