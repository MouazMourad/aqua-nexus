...
export function EquipmentAddModal(props:{
 ...
 return <Modal open={p.open} title={tr(p.lang,"addEquipment")} onClose={p.onClose}>
  ...
  <AdvancedSection titleAr="مواصفات الجهاز المتقدمة" titleEn="Advanced device specifications" summaryAr="الاسم والنوع والموقع كافيين كبداية. هالمواصفات بتحسن تقييم الكفاية والطاقة والعمر لما تكون معروفة." summaryEn="Name, type and location are enough to start. These specifications improve adequacy, energy and lifecycle analysis when known.">
   <div style={{display:"grid",gap:9,paddingTop:10}}>
    <ContextHint id="equipment-specs" lang={p.lang} ar="Flow وRated Volume وPAR مو حقول إلزامية؛ عبّيها فقط من مواصفات موثوقة للجهاز حتى ما يدخل تخمين على تقييم الحوض." en="Flow, rated volume and PAR are optional; enter them only from reliable device specifications so estimates do not become false facts."/>
    <div className="form-grid">
