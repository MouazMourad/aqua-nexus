...
function genericAction(tank:Tank,key:string,dir:"low"|"high"|"ideal"){
  ...
  if(key==="NO3")return dir==="low"
    ? (tank.type==="freshwater"&&(tank.ecosystemProfile==="planted"||tank.ecosystemProfile==="mixed"||tank.livestock.some(x=>x.category==="plant"))?{ar:"في الحوض المزروع، راجع نمو النباتات وروتين التسميد والحمل الحيوي قبل إضافة نيتروجين. لا تشخّص نقص N من رقم واحد أو شكل الورقة وحده.",en:"In a planted tank, review plant growth, fertilization routine and bioload before adding nitrogen. Do not diagnose N deficiency from one reading or leaf appearance alone."}:{ar:"لا تخفّض المغذيات أكثر. راقب التغذية والمرجان وتجنب الإفراط في التصفية أو الكربون العضوي.",en:"Do not strip nutrients further. Review feeding/coral response and avoid excessive filtration or carbon dosing."})
    : (tank.type==="freshwater"&&(tank.ecosystemProfile==="planted"||tank.ecosystemProfile==="mixed"||tank.livestock.some(x=>x.category==="plant"))?{ar:"راجع التسميد والحمل الحيوي والتغذية ونمو النباتات وتغييرات الماء معاً. لا تخفض NO3 بعنف لأن النباتات تستخدمه كمغذٍ.",en:"Review fertilization, bioload, feeding, plant growth and water changes together. Avoid aggressive NO3 reduction because plants use nitrate as a nutrient."}:{ar:"ابدأ بإزالة مصادر الحمل العضوي: بقايا أو كائن ميت، نظف الفلاتر والجوارب، حسّن السكيمر وغيّر ماء مناسب. خفّضه تدريجياً.",en:"Remove organic sources first: debris or dead livestock, clean mechanical filters/socks, optimize skimming, and perform an appropriate water change. Reduce gradually."});
