...
export function parseAquaQuestion(raw:string):AquaQuestionIntent{
 ...
 if(params.length||hasAny(s,["كيميا","كيمياء","قراءه","قراءات","chemistry","parameter","reading","readings"]))add("chemistry");
 ...
 if(hasAny(s,["صيانه","صيانة","صيانته","صيانتها","تنظيف","موعد","مهمه","مهمة","maintenance","clean","service"]))add("maintenance");
 ...
 if(hasAny(s,["تغيير مي","تغيير ماء","بدل مي","غير مي","غير ماء","water change","change water"]))add("water");
 ...
 else if(hasAny(s,["تغيير مي","تغيير ماء","بدل مي","water change","change water"]))mode="waterChange";
