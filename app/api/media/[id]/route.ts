...
export async function GET(request:NextRequest,{params}:Params){
  try{
    ...
    return new NextResponse(asset.data,{status:200,headers:{"content-type":asset.mimeType,"content-length":String(asset.sizeBytes),"cache-control":"private, max-age=3600"}});
